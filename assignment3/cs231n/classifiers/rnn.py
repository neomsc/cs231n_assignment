...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions,weight_decay = 0.0):
        """
        ...
        if weight_decay!=0.0:
            #loss+=0.5 * weight_decay * (np.sum(W_proj ** 2) + np.sum(W_embed ** 2) + np.sum(Wx ** 2) + np.sum(Wh ** 2) + np.sum(W_vocab ** 2))
            loss += 0.5 * weight_decay * (np.sum(W_embed ** 2) + np.sum(Wx ** 2) + np.sum(Wh ** 2) + np.sum(W_vocab ** 2))
        ...
        if weight_decay != 0.0:
            #grads['W_proj']+=weight_decay*W_proj
            grads['W_embed'] += weight_decay * W_embed
            grads['Wx'] += weight_decay * Wx
            grads['Wh'] += weight_decay * Wh
            grads['W_vocab'] += weight_decay * W_vocab
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
